...
def get_rotation_samples(label, num_samples):
    all_rots = []
    name_sym_dict = {
        ...
        "013_apple_google_16k": [0,0], #half_0-pi
        "029_plate_google_16k": [1,0], #half_0-pi
        "030_fork_google_16k": [1,2], #half_0-pi
        "031_spoon_google_16k": [1,2], #half_0-pi
        "032_knife_google_16k": [0,2], #half_0-pi
        ...
        # "009_gelatin_box": [0,0], #half_0-pi
        # "010_potted_meat_can": [0,0], #half_0-pi
        # "011_banana": [0,0], #whole_0-2pi #from psc
        # "019_pitcher_base": [0,0], #whole_0-2pi
        # "021_bleach_cleanser": [0,0], #whole_0-2pi, 55 and
        # "024_bowl": [0,0], #whole_0
        # "025_mug": [0,0], #whole_0-2pi
        # "035_power_drill" : [0,2], #whole_0-2pi
        # "036_wood_block": [0,0], #half_0-pi
        # "037_scissors": [0,0], #whole_0-2pi
        # "040_large_marker" : [0,0], #whole_0
        # "052_extra_large_clamp": [0, 0],  #whole_0-pi
        # "051_large_clamp": [0,0],
        # "061_foam_brick": [0,0], #half_0-pi
        ...
        "004_sugar_box":            [0,0], #half_0-pi
        "005_tomato_soup_can":      [0,0], #half_0
        "006_mustard_bottle":       [1,0], #whole_0-pi
        "007_tuna_fish_can":        [0,0], #half_0
        ...
        "051_large_clamp":          [0,7],
        "061_foam_brick":           [0,0], #half_0-pi
        "water_bottle":             [1,0], #half_0-pi
        "coca_cola":                [1,0], #half_0-pi

        # LM-O
        # "Ape":          [0,0], #half_0-pi
        # "Can":          [0,0], #whole_0-2pi
        # "Cat" :         [0,0], #whole_0
        # "Driller":      [0,0],  #whole_0-pi
        # "Duck":         [0,0],
        # "Eggbox":       [0,0], #half_0-pi
        # "Glue":         [0,0],
        # "Holepuncher":  [0,0], #half_0-pi
        ...
        # "002_master_chef_can":      [0,7], #half_0
        # "003_cracker_box":          [0,7], #half_0-pi #0,0 is fine with gicp
        # "004_sugar_box":            [0,7], #half_0-pi
        # "005_tomato_soup_can":      [0,7], #half_0
        # "006_mustard_bottle":       [0,7], #whole_0-pi
        # "007_tuna_fish_can":        [0,7], #half_0
        # "008_pudding_box":          [0,7], #half_0-pi
        # "009_gelatin_box":          [0,7], #half_0-pi
        # "010_potted_meat_can":      [0,7], #half_0-pi
        # "011_banana":               [0,7], #whole_0-2pi #from psc
        # "019_pitcher_base":         [0,7], #whole_0-2pi
        # "021_bleach_cleanser":      [0,7], #whole_0-2pi, 55 and
        # "024_bowl":                 [0,7], #whole_0
        # "025_mug":                  [0,7], #whole_0-2pi
        # "035_power_drill" :         [0,7], #whole_0-2pi
        # "036_wood_block":           [0,7], #half_0-pi
        # "037_scissors":             [0,7], #whole_0-2pi
        # "040_large_marker" :        [0,7], #whole_0
        # "052_extra_large_clamp":    [0,7],  #whole_0-pi
        # "051_large_clamp":          [0,7],
        # "061_foam_brick":           [0,7], #half_0-pi

        # "002_master_chef_can":      [1,7], #half_0
        # "003_cracker_box":          [1,7], #half_0-pi #0,0 is fine with gicp
        # "004_sugar_box":            [1,7], #half_0-pi
        # "005_tomato_soup_can":      [1,7], #half_0
        # "006_mustard_bottle":       [1,7], #whole_0-pi
        # "007_tuna_fish_can":        [1,7], #half_0
        # "008_pudding_box":          [1,7], #half_0-pi
        # "009_gelatin_box":          [1,7], #half_0-pi
        # "010_potted_meat_can":      [1,7], #half_0-pi
        # "011_banana":               [1,7], #whole_0-2pi #from psc
        # "019_pitcher_base":         [1,7], #whole_0-2pi
        # "021_bleach_cleanser":      [1,7], #whole_0-2pi, 55 and
        # "024_bowl":                 [1,7], #whole_0
        # "025_mug":                  [1,7], #whole_0-2pi
        # "035_power_drill" :         [1,7], #whole_0-2pi
        # "036_wood_block":           [1,7], #half_0-pi
        # "037_scissors":             [1,7], #whole_0-2pi
        # "040_large_marker" :        [1,7], #whole_0
        # "052_extra_large_clamp":    [1,7],  #whole_0-pi
        # "051_large_clamp":          [1,7],
        # "061_foam_brick":           [1,7], #half_0-pi
    }
